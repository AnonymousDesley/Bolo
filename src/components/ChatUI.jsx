...
export default function ChatUI() {
  ...
  const handleSend = async (e) => {
    ...
    return (
      ...
      <div className="flex flex-col h-[90vh] max-w-2xl mx-auto p-4 bg-[#0c0c0c] rounded-2xl shadow-lg border border-purple-800 relative overflow-hidden chat-ui">
        ...
        <div className="flex-1 overflow-y-auto mt-16 space-y-3 p-2 scrollbar-hide">
