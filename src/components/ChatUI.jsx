    ...
    try {
      ...
      setLoading(false);
                                ...
                                return (
                                  ...
                                  <div className="flex flex-col h-full min-h-screen max-w-2xl mx-auto p-4 bg-[#0c0c0c] rounded-2xl shadow-lg relative overflow-hidden chat-ui chat-container-gradient">
